                ...
                <section className="relative py-20 bg-gradient-to-br from-primary-50 via-white to-accent-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <motion.h1
                            ...
                            className="text-5xl md:text-7xl font-serif text-gray-900 mb-8 leading-tight bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent"
                        >
                        ...
                        <motion.p
                            ...
                            className="text-lg text-gray-600 leading-relaxed font-sans max-w-3xl mx-auto"
                        >
